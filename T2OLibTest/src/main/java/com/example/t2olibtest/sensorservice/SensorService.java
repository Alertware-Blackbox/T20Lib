package com.example.t2olibtest.sensorservice;
...
import com.example.t2olibtest.brodcastreceiver.SensorRestarterBroadcastReceiver;
...
public class SensorService extends Service implements BleWrapperUiCallbacks {
    ...
    public void startBle(){
        /*bluetooth = Bluetooth.getInstance((DashboardActivity)mApplicationContext,
                this);*/
        ...
        new AsyncTask<Void, Void, Void>() {
            ...
            protected Void doInBackground(Void... voids) {
                /*bluetooth.connect(WristbandSharePref.getPairedMac(
                        (DashboardActivity)mApplicationContext));*/
                return null;
            }
            ...
            protected void onPostExecute(Void aVoid) {
                ...
                try {
                    bluetooth.getCharacteristicValue(bluetooth.getGatt().getServices().get(6).getCharacteristics().get(1));
